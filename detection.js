...
let canvas = createCanvas(5000, 600);
let context = canvas.getContext('2d');
const wF = 1/16; //weight factor (lambda)
let faultDuration = 20;//cycles
...
let faultMf = 1;//fault multiplication factor
function Gwave(sN){
    let mf = 1;
...
let minV = 10;
let maxV = 100;
let minVsqr = minV**2 * (1- (b)*Math.sqrt(b**2+(2*omega)**2)/(b**2+4*omega**2)); //b=lambda/s
...
//error calculation for square wave, setpoint maxV
/*let errorSqrWave = Math.sqrt(maxV**2 * ((b)*Math.sqrt(b**2+(2*omega)**2)/(b**2+4*omega**2)));
console.log("error on square wave maxV:" + errorSqrWave);
console.log("Same error in % of maxV:"+(errorSqrWave/maxV)*100 + "%")*/
console.log("sqrt(maxVsqr):"+Math.sqrt(maxVsqr));
console.log("sqrt(maxVsqr2):"+Math.sqrt(maxVsqr2));

let errorSqrWavemin = (maxV) * Math.sqrt(1-b*(Math.sqrt(b**2+(2*omega)**2))/(b**2+4*omega**2));
console.log("error on square wave maxV (min):" + errorSqrWavemin);
console.log("Same error in % of maxV:"+(1-errorSqrWavemin/maxV)*100 + "%");
let errorSqrWavemax = (maxV) * Math.sqrt(1+b*(Math.sqrt(b**2+(2*omega)**2))/(b**2+4*omega**2));
console.log("error on square wave maxV (max):" + errorSqrWavemax);
console.log("Same error in % of maxV:"+(1-errorSqrWavemax/maxV)*100 + "%");
...
for(let i = 0; i < 1700; i++){
    ...
    //sqAvg.Vc = sqAvg.Vc + (wF*(signal.Va**2-sqAvg.Vc)); //testing Exponential moving average
    let vRMS = 
    {
    ...
    RMSsamplesSum += sqAvg.Va; //calculating actual RMS value for phase A only
    RMSsamplesN += 1;
    if(RMSsamplesN == (SPC/2)){ //CALCULATING RMS VALUE
        //console.log("Calculated RMS value:" + Math.sqrt(RMSsamplesSum/(SPC/2)));
        RMSsamplesN = 0;
        RMSsamplesSum = 0;
    }
    if(i>950){
        ...
        */
        ...
        if(sqAvg.Va > maxVsqr || sqAvg.Va < minVsqr){
            ...
            if(sqAvg.Va >= minVsqr2 /*&& sqAvg.Va <= maxVsqr2*/){
                ...
                if(i>(1000+faultDuration*SPC)){
                    //console.log("a1:"+sqAvg);
                    //console.log("a2:"+minVsqr2);
                    //console.log("a3:"+(minVsqr2-sqAvg.Va));
...
//undervoltage detection and stabilization
//phase A
/*context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,100-Math.sqrt(minVsqr)*vs);
context.lineTo(4500,100-Math.sqrt(minVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,100-Math.sqrt(minVsqr2)*vs);
context.lineTo(4500,100-Math.sqrt(minVsqr2)*vs);
context.stroke();
//PHASE B
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,300-Math.sqrt(minVsqr)*vs);
context.lineTo(4500,300-Math.sqrt(minVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,300-Math.sqrt(minVsqr2)*vs);
context.lineTo(4500,300-Math.sqrt(minVsqr2)*vs);
context.stroke();
//PHASE C
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,500-Math.sqrt(minVsqr)*vs);
context.lineTo(4500,500-Math.sqrt(minVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,500-Math.sqrt(minVsqr2)*vs);
context.lineTo(4500,500-Math.sqrt(minVsqr2)*vs);
context.stroke();
*/
//overcurrent detection and stabilization
//phase A
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,100-Math.sqrt(maxVsqr)*vs);
context.lineTo(4500,100-Math.sqrt(maxVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,100-Math.sqrt(maxVsqr2)*vs);
context.lineTo(4500,100-Math.sqrt(maxVsqr2)*vs);
context.stroke();
//PHASE B
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,300-Math.sqrt(maxVsqr)*vs);
context.lineTo(4500,300-Math.sqrt(maxVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,300-Math.sqrt(maxVsqr2)*vs);
context.lineTo(4500,300-Math.sqrt(maxVsqr2)*vs);
context.stroke();
//PHASE C
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,500-Math.sqrt(maxVsqr)*vs);
context.lineTo(4500,500-Math.sqrt(maxVsqr)*vs);
context.stroke();
//drawing min
context.strokeStyle = "pink";
context.beginPath();
context.moveTo(0,500-Math.sqrt(maxVsqr2)*vs);
context.lineTo(4500,500-Math.sqrt(maxVsqr2)*vs);
context.stroke();
